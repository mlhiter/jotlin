  ...
  return (
    <div
      ...
      <div
        ...
        className={cn(
          'w-(--sidebar-width) relative bg-transparent transition-[width] duration-700 ease-in-out',
      ...
      <div
        ...
        className={cn(
          'w-(--sidebar-width) fixed inset-y-0 z-10 hidden h-svh transition-[left,right,width] duration-700 ease-in-out md:flex',
          side === 'left'
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        'text-sidebar-foreground/70 ring-sidebar-ring outline-hidden flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium transition-[margin,opacity] duration-700 ease-in-out focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<'ul'>) {
  return (
    <ul
      ...
      className={cn(
        'border-sidebar-border flex min-w-0 translate-x-px flex-col gap-1 border-l py-0.5 pl-2.5',
        'group-data-[collapsible=icon]:hidden',
        className
      )}
      {...props}
